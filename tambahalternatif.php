...
<div class="box-body pad">
 ...
 <br />
 <input type="text" name="nm_alternatif" class="form-control"  placeholder="Nama Kriteria" >
 <br />
...
if(isset($_POST['simpan'])){
	$result=mysqli_query($conn,"insert into alternatif (id_alternatif,nm_alternatif) values('$_POST[id_alternatif]','$_POST[nm_alternatif]')");
