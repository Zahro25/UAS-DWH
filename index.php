...
<body style="background-image:url(bg1.jpg); background-size:1200px; background-repeat:no-repeat;background-position:220px 0px;">

<nav class="navbar navbar-dark bg-primary" style="height:70px;">
  <div class="container-fluid">
    <div class="navbar-header">
      <a style="color:white; font-size:240%; margin-top:10px;margin-left:95px;" class="navbar-brand"  href="#">SPK LOKASI JUALAN LOK-LOK STATEGIS METODE TOPSIS</a>
    </div>
